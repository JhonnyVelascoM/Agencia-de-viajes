...
<body>
                    ...
                    <form action="#" method="post">
                        <div class="row justify-content-between align-items-end">
                            <div class="col-4 col-md-3">
                                <label for="room">Destinos</label>
                                <div id="selectD">
                                    
                                </div>
                            </div>
                            <div class="col-6 col-md-2 col-lg-3">
                                <label for="checkIn">Fecha Salida</label>
                                <input type="date" class="form-control" id="checkIn" name="checkin-date">
                            </div>
                            <div class="col-6 col-md-2 col-lg-3">
                                <label for="checkOut">Fecha Llegada</label>
                                <input type="date" class="form-control" id="checkOut" name="checkout-date">
                            </div>

                            <div class="col-12 col-md-3">
                                <button type="button" class="form-control btn roberto-btn w-100" onclick="getTourLugar()">Buscar</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="roberto-rooms-area section-padding-100-0">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8" id="list_tours">
