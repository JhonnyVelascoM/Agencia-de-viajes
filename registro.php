                    ...
                    <?php   
                            ...
                            if ($msg){
                                if ($_GET['msg'] == 'true')
                                 echo '<div class="alert alert-success'.'" role="alert">
                                     Se ha registrado con éxito<button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-xl-7 mx-auto">
                                ...
                                <form action="funciones/validar_registro.php" method="POST">
                                    <div class="form-group mb-3">
                                        <input id="nombre" name="nombre" type="nombre" placeholder="Nombre" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="text-center d-flex justify-content-between mt-4">
                                        <p>¿Ya tienes cuenta? <a href="login.php"> Inicia Sesion </a>
                                        </p>
                                    </div>
                                </form>
                            </div>
